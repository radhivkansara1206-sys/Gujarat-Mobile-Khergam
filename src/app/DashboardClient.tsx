...
👤 *Closed By:* ${summaryData.closedBy}`;
  ...
  return (
    <div>
      ...
      {/* Stats Grid */}
      <DashboardStatsGrid stats={stats} isAdmin={isAdmin} />
            ...
            <div id="summary-content" style={{ padding: '0.5rem', background: '#fff' }}>
              ...
              <div className="grid-2" style={{ gap: '1rem', marginBottom: '1.5rem' }}>
                <div style={{ background: 'var(--success-light)', color: 'var(--success-dark)', padding: '1rem', borderRadius: '12px', textAlign: 'center' }}>
                  <p style={{ margin: 0, fontSize: '0.8rem', fontWeight: 500 }}>Cash Sales</p>
                  <p style={{ margin: '0.25rem 0 0 0', fontSize: 'clamp(1.15rem, 3vw, 1.35rem)', fontWeight: 800 }}>{formatCurrency(summaryData.salesCash)}</p>
                </div>
                <div style={{ background: 'var(--info-light)', color: 'var(--info-dark)', padding: '1rem', borderRadius: '12px', textAlign: 'center' }}>
                  <p style={{ margin: 0, fontSize: '0.8rem', fontWeight: 500 }}>Online Sales</p>
