      ...
      <div style={{ padding: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
          ...
          <div style={{ background: '#ecfdf5', padding: '1rem', borderRadius: '12px', border: '1px solid #d1fae5', textAlign: 'center' }}>
            <p style={{ margin: 0, fontSize: '0.75rem', color: '#059669', textTransform: 'uppercase', fontWeight: 700 }}>Cash Sales</p>
            <p style={{ margin: '0.5rem 0 0 0', fontSize: '1.25rem', fontWeight: 800, color: '#065f46' }}>{formatCurrency(summaryData.salesCash)}</p>
          </div>
          <div style={{ background: '#eff6ff', padding: '1rem', borderRadius: '12px', border: '1px solid #dbeafe', textAlign: 'center' }}>
            <p style={{ margin: 0, fontSize: '0.75rem', color: '#2563eb', textTransform: 'uppercase', fontWeight: 700 }}>Online Sales</p>
